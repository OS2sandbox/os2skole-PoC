# Initial Envisioning of Non-Functional Requirements
...
> * Integration in OS2Skole central observability system (which is part of OS2Skole Monitoring)
...
> *   **Patching Time:** In the event of a major security vulnerability (e.g., similar to Log4j), the system must be capable of being patched with upstream vendor updates within **3 hours**. [Unkown: what is the industry strandard here?]
...
> *   **Data Sovereignty:** All data must be processed and stored within the **European Union (EU)**. Data and running processes [there probably is a better phrasing for what we mean here?] must not be under the control of any entity falling under the legal jurisdiction of a non-EU country, including but not limited to frameworks like the U.S. CLOUD Act and FISA. 
> *   **Vendor Neutrality:**
